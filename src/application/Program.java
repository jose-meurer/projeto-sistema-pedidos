...
public class Program {
    public static void main(String[] args) {
        ...
        do {
            for (int i = 0; i < n; i++) {
                ...
                OrderStatus orderStatus = Program.statusOrder(statusValue);
        ...
        if (changeStatus == 's' || changeStatus == 'S'){
            ...
            switch (numberChangeStatus){
                ...
                case 3:
                    ...
                    int statusValue = sc.nextInt();
                    order.setStatus(Program.statusOrder(statusValue));
    ...
    private static OrderStatus statusOrder(int statusValue){
        Scanner sc = new Scanner(System.in);
